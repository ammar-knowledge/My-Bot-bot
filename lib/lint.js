...
async function commitlint(context) {
	...
	const repo = context.repo(); // returns e.g { owner: 'Ammar', repo: 'Ammar-Knowledge' }
	const pull_info = context.issue(); // returns e.g {number: 47, owner: 'Ammar', repo: 'Ammar-Knowledge'}
