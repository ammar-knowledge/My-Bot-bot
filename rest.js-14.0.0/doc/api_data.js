define({ "api": [
  ...
  },
  {
    ...
    "group": "D__my_meri_commitlint_bot_glitch_new_rest_js_14_0_0_doc_main_js",
    "groupTitle": "D__my_meri_commitlint_bot_glitch_new_rest_js_14_0_0_doc_main_js",
    "name": ""
  },
  {
    "type": "POST",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await github.issues.getForRepo({owner, repo, milestone, state, assignee, creator, mentioned, labels, sort, direction, since, page, per_page})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "github.issues.getForRepo({owner, repo, milestone, state, assignee, creator, mentioned, labels, sort, direction, since, page, per_page}).then(result => {})",
        "type": "js"
      },
      {
        "title": "Callback",
        "content": "github.issues.getForRepo({owner, repo, milestone, state, assignee, creator, mentioned, labels, sort, direction, since, page, per_page}, (error, result) => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await github.repos.create({name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "github.repos.create({name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge}).then(result => {})",
        "type": "js"
      },
      {
        "title": "Callback",
        "content": "github.repos.create({name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge}, (error, result) => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await github.repos.createDeployment({owner, repo, ref, task, auto_merge, required_contexts, payload, environment, description, transient_environment, production_environment})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "github.repos.createDeployment({owner, repo, ref, task, auto_merge, required_contexts, payload, environment, description, transient_environment, production_environment}).then(result => {})",
        "type": "js"
      },
      {
        "title": "Callback",
        "content": "github.repos.createDeployment({owner, repo, ref, task, auto_merge, required_contexts, payload, environment, description, transient_environment, production_environment}, (error, result) => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await github.repos.createForOrg({org, name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "github.repos.createForOrg({org, name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge}).then(result => {})",
        "type": "js"
      },
      {
        "title": "Callback",
        "content": "github.repos.createForOrg({org, name, description, homepage, private, has_issues, has_projects, has_wiki, team_id, auto_init, gitignore_template, license_template, allow_squash_merge, allow_merge_commit, allow_rebase_merge}, (error, result) => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await github.repos.edit({owner, repo, name, description, homepage, private, has_issues, has_projects, has_wiki, default_branch, allow_squash_merge, allow_merge_commit, allow_rebase_merge})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "github.repos.edit({owner, repo, name, description, homepage, private, has_issues, has_projects, has_wiki, default_branch, allow_squash_merge, allow_merge_commit, allow_rebase_merge}).then(result => {})",
        "type": "js"
      },
      {
        "title": "Callback",
        "content": "github.repos.edit({owner, repo, name, description, homepage, private, has_issues, has_projects, has_wiki, default_branch, allow_squash_merge, allow_merge_commit, allow_rebase_merge}, (error, result) => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
